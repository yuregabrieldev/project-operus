        ...
        <div className="space-y-4 md:space-y-6 bg-background min-h-screen">
            <div className="bg-card border-b">
                <div className="px-4 md:px-6 pt-4 md:pt-6 pb-3 md:pb-4 space-y-3 md:space-y-4">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-foreground">{t('purchases.title')}</h1>
                        <p className="text-xs md:text-sm text-muted-foreground mt-1">{t('purchases.subtitle')}</p>
                    </div>
